define(["ember"], function(Ember){
	var long_short_data = [ 
        ...
        mailemail:"mailto:ali@mosaicmemphis.com"
			  ...
			  },
			  {
				...
				role: "Mosaic City Groups Pastor",
        email: "trevor@mosaicmemphis.com",
        mailemail: "mailto:trevor@mosaicmemphis.com"
        ...
        email:"weston@mosaicmemphis.com",
        mailemail:"mailto:weston@mosaicmemphis.com"
			  },
			  {
				name: 'Brad Wyatt',
				pic: "img/Brad.jpg",
				...
				role: "Connections/Shepherding",
        email:"brad@mosaicmemphis.com",
        mailemail:"mailto:brad@mosaicmemphis.com"
			  },
			  {
				name: 'Donroy Providence',
				pic: "img/donroy.jpg",
				bioPic: "background:url(img/donroyBig.jpg);",
				bio:  "Donroy hails from the Caribbean Island of St. Vincent and the Grenadines. He moved to Memphis, Tennessee in the winter of January 2013 to pursue studies in Worship leadership at Visible Music College in the Downtown area. He grew up in church and it was there that his skill for singing was developed. He became a part of numerous musical and also missionary groups. It was through these organizations that he realized he had a passion for music and mission work. He felt that his passion for music was intertwined with his purpose. He decided to make the bold step of faith by moving to this wonderful city to hone his skill. While in the city of Memphis, he enjoys walking on Main and Beale Street, taking in the beautiful sounds of the city.",
				role: "Worship Leader",
        email: "donroy@mosaicmemphis.com",
        mailemail: "mailto:donroy@mosaicmemphis.com"
			  },
			  {
				name: 'Jared Raney',
				pic: "img/jared.jpg",
				bioPic: "background:url(img/jaredBig.jpg);",
				bio:  "Jared is a local (Berclair-area) Memphian and artist who has been involved in media and technology all his life; as well, an avid brainstormer and problem solver who has performed many roles in local churches over the years. After graduating from the University of Memphis and pursuing many passions, he always finds himself drawn back to serving where needed.Mosaic’s passion for diversity and openness to new ideas keeps Jared’s creativity flowing. He believes that creating and maintaining quality audio and visual experiences are key to reaching those who wouldn’t normally grace the doors of a church.Committed to positive growth and grace in the city, Jared, his wife, Meredith, and baby, Enoch seek to bridge the gap between the negative neighborhood stigma and a hope filled life in Christ.",
				role: "Audio/Video Director",
        email:"jared@mosaicmemphis.com",
        mailemail:"mailto:jared@mosaicmemphis.com"
			  },
        {
				name: 'Rhonda Hurd',
				pic: "img/rhonda.jpg",
				bioPic: "background:url(img/rhondaBig.jpg);",
				bio:  "Rhonda was born and raised in Memphis . She has been married to her husband, David for 30 years. They have two grown children, Aaron who is married to Kassie and Ryan Hurd.  She has two grandchildren- David Aaron and Raeanna. Rhonda enjoys spending time with family, camping and going to yard sales in her spare time. She is so thankful that Jesus has given her the opportunity of serving by doing what she loves most....”planting the seed of HIS love in the hearts of children”. Through Mosaic she wants to help each child reach the full potential God has created in them and for them to become devoted followers of Jesus Christ.",
				role: "Mosaic Kids Director",
        email:"kids@mosaicmemphis.com",
        mailemail:"mailto:kids@mosaicmemphis.com"
			  },
        {
				name: ' Larry Ray Reed',
				pic: "img/larry.jpg",
				bioPic: "background:url(img/larryBig.jpg);",
				bio:  'Larry Ray hails from the "Historic City of the Future” – Jones Creek, Texas.  He loves all things Texas and small town but somehow Memphis has stolen his heart.  After graduating from Texas Tech, Larry Ray moved to Memphis to crunch numbers for SOS, a home repair ministry he had worked for during his college summers.  His life was radically changed during those summers at SOS when he realized that Jesus was not just a piece of the pie (of life), but that Jesus IS the pie!  This set Larry Ray’s life on a new course, living strategically and completely for God’s glory.  Now working as the Dean of Finance & Operations at The Collegiate School of Memphis, Larry Ray’s job combines some of the things he loves most in life – urban education, Jesus, and keeping everyone\'s "life in order.” Larry Ray prefers his food "piping hot" and his house frigid cold.  He loves a healthy dose of sarcasm, enjoys late night walks, and dreams of marrying a 30-year-old Reba McEntire.  Larry Ray is excited to see God build His Kingdom through Mosaic and for us to learn and serve as family together.',
				role: "Financial Director",
        email:"larryray@mosaicmemphis.com",
        mailemail:"mailto:larryray@mosaicmemphis.com"
			  }
			];
